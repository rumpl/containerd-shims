...
COPY --link --from=build-containerd-wasm-spin-shim /containerd-shim-spin-v1 /containerd-shim-spin-v1
COPY --link --from=build-containerd-wasm-slight-shim /containerd-shim-slight-v1 /containerd-shim-slight-v1
